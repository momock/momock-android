...
public abstract class ActionMode {
	 ...
	 * {@link ActionMode.Callback} will have its
	 * {@link Callback#onPrepareActionMode(ActionMode, Menu)} method called. If
	 * it returns true the menu will be scanned for updated content and any
