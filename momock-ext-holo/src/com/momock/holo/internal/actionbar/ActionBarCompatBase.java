...
import com.momock.holo.internal.menu.MenuItemImpl;
import com.momock.holo.widget.PopupMenu;
import com.momock.holo.widget.PopupMenu.OnMenuItemClickListener;
...
public class ActionBarCompatBase extends ActionBarCompat implements ActionBar {
	...
	public void hideInRealMenu(final Menu menu) {
	...
	public void setProgressBarIndeterminateEnabled(final boolean enabled) {
